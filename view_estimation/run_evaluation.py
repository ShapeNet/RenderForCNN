...
det_bbox_mat_file_list = [x.rstrip() for x in open(g_rcnn_detection_bbox_mat_filelist)]
...
view_label_folder = os.path.join(g_real_images_voc12val_easy_gt_bbox_folder)
